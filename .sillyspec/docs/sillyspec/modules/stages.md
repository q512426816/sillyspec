...
- ql-20260814-007-b94b | brainstorm/brainstorm-auto 开放回答型 wait 步骤声明 waitFreeAnswer: true（「对话式探索与需求澄清」澄清追问），豁免 wait 选项单选强制（wait-choice-enforcement，complete.js enforceWaitChoice）——封闭单选 wait 的 --answer 必须命中 waitOptions，开放型为自由文本。
