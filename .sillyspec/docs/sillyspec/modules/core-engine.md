...
> R7 注记：2026-09-22-r7-protocol-surgery（新增 src/machine-draft.js 三件套原语泛化——wrapSection/verifyMarkers/reanchorText，AMEND_CMD 参数化；verify-draft.js 消费方化六导出零回归）
