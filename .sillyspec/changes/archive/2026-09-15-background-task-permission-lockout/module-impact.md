...
- `sillyhub-daemon/src/interactive/session-manager/events.ts` <!--TODO: 归属判定-->
- `sillyhub-daemon/src/interactive/session-manager/background-tasks.ts` <!--TODO: 归属判定-->
- `sillyhub-daemon/src/interactive/session-manager.ts` <!--TODO: 归属判定-->
- `sillyhub-daemon/src/interactive/session-manager/permission.ts` <!--TODO: 归属判定-->
- `sillyhub-daemon/src/interactive/permission-resolver.ts` <!--TODO: 归属判定-->
...
- `backend/app/modules/agent/service.py` <!--TODO: 归属判定-->
