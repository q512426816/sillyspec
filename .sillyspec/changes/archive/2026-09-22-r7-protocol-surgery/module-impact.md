...
| core-engine | `src/verify-draft.js` | <!--TODO--> | <!--TODO--> |
| runtime | `src/run/command.js` | <!--TODO--> | <!--TODO--> |
| runtime | `src/run/complete-handlers.js` | <!--TODO--> | <!--TODO--> |
| setup | `src/config-schema.js` | <!--TODO--> | <!--TODO--> |
...
- `src/watcher.js` <!--TODO: 归属判定-->
- `src/flow.js` <!--TODO: 归属判定-->
- `src/machine-draft.js` <!--TODO: 归属判定-->
- `src/flow-draft.js` <!--TODO: 归属判定-->
- `test/watcher.test.mjs` <!--TODO: 归属判定-->
- `test/archive-chain.test.mjs` <!--TODO: 归属判定-->
- `test/machine-draft.test.mjs` <!--TODO: 归属判定-->
- `test/flow-protocol.test.mjs` <!--TODO: 归属判定-->
- `test/flow-draft.test.mjs` <!--TODO: 归属判定-->
- `test/flow-route.test.mjs` <!--TODO: 归属判定-->
