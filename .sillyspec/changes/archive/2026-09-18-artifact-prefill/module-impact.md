...
- `src/prefill.js` → core-engine（纯函数族）
- `src/index.js` → cli-entry
- `src/run/gates.js` → runtime
- `src/verify-probes.js` → core-engine（探针族）
- `test/prefill.test.mjs` → core-engine
- `docs/sillyspec/cost-baseline-2026-09-18.md` → docs-consistency
