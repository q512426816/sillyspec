...
updated_at: 2026-08-24（+批次②：taskcard 占位符硬拦 / Wave 依赖方向硬拦 + plan-adopt-waves / decisions.md header 模板根治+自动补齐 / quick 新会话缺 --input 拒绝启动 + 位置参数即任务描述 / --file-notes 格式 fail-fast）
---
