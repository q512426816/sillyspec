 ...
 *
 * 验证 baseline hash 排除非交付物 churn（元数据/文档/agent 指引），只对源码 baseline 敏感。
 * 否则多操作者仓库里别人改 CLAUDE.md/docs/.claude → 整树 hash 变 → apply 误阻断（高频踩坑）。
 * 安全：apply step5a(未提交∩changedFiles)+step5b(HEAD blob) 精确校验交付文件，
 *       coarse hash 放过这些不丢真冲突。
