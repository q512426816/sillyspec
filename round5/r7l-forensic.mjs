...
writeFileSync('round5/audit/r7l-requests.jsonl', reqs.map(r => JSON.stringify(r)).join('\n'));
writeFileSync('round5/audit/r7l-toolinputs.jsonl', tins.map(t => JSON.stringify(t)).join('\n'));
console.log('\n数据已落 round5/audit/r7l-*.jsonl');
